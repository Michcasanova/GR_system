			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
						...
						$Antecedente_clinico=$row['Antecedente_clinico'];
						$status=$row['status'];
					...
					<input type="hidden" value="<?php echo $Nombre;?>" id="Nombre<?php echo $id_conductor;?>">
					<input type="hidden" value="<?php echo $Seguro_social;?>" id="Seguro_social<?php echo $id_conductor;?>">
					<input type="hidden" value="<?php echo $Num_licencia;?>" id="Num_licencia<?php echo $id_conductor;?>">
					<input type="hidden" value="<?php echo $Antecedente_clinico;?>" id="Antecedente_clinico<?php echo $id_conductor;?>">
					<input type="hidden" value="<?php echo $status;?>" id="status<?php echo $id_conductor;?>">
					
					<tr>
						
						<td><?php echo $Nombre; ?></td>
						<td ><?php echo $Seguro_social; ?></td>
						<td><?php echo $Num_licencia;?></td>
						<td><?php echo $Antecedente_clinico;?></td>
